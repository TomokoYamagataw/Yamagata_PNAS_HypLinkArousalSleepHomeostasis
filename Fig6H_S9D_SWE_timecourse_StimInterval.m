...
inBetween3 = [data_mean(3,:)+err(3,:), fliplr(data_mean(3,:)-err(3,:))];
inBetween4 = [data_mean(4,:)+err(4,:), fliplr(data_mean(4,:)-err(4,:))];
patch(f2, inBetween1, 'm' ,'EdgeColor', 'none', 'FaceAlpha', 0.3);
hold on
patch(f2, inBetween2, 'c' ,'EdgeColor', 'none', 'FaceAlpha', 0.3);
patch(f2, inBetween3, 'r' ,'EdgeColor', 'none', 'FaceAlpha', 0.3);
patch(f2, inBetween4, 'b' ,'EdgeColor', 'none', 'FaceAlpha', 0.3);
