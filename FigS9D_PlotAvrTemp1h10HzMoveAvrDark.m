...
days=['090919 160919';'090919 160919';'090919 160919';'090919 160919']; 
...
%     end
    ...
    if anim==3
        ...
        out0=find(tmpc(1,1:10800)<32);
        tmpc(out0)=NaN;            
        
        out1=find(tmpc(1,10801:11200)<29)+10800;
        tmpc(out1)=NaN;            

        out2=find(tmpc(1,11201:11600)<28)+11200;
        tmpc(out2)=NaN;  
        
        out3=find(tmpc(1,11601:11800)<27)+11600;
        tmpc(out3)=NaN;  
        
        out4=find(tmpc(1,11801:12000)<30)+11800;
        tmpc(out4)=NaN;  
 
        out5=find(tmpc(1,12001:end)<32)+12000;
        tmpc(out5)=NaN;  
        figure
        plot(tmpc) 
        
        Temp=tmpc;
        for cc=1:length(Temp)
            if isnan(Temp(1,cc))==1
                Temp(1,cc)=Temp(1,cc-1);
            end
        end
    end
    ...
    Tempmoveavr=Tempmoveavr(9001:maxep);
    
    figure
    plot(Tempmoveavr)
%     t6h=NaN(1,6400);
    tmavs=Tempmoveavr(1,1:length(Tempmoveavr)); %640
    ...
    minTstim=min(normT(1,1801:2700));
