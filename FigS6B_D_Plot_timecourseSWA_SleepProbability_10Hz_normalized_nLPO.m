...
pathvs=[path,'outputVS\']; %defines the folder with output files of vigilance states for mice1 (GFP ctrl)
...
% elseif geno==4
%     mousenames=mousenames4; days=days4; gn='GDCh'; 
% elseif geno==8
%     mousenames=mousenames8; days=days8; gn='GDCh'; 
end
